...
下面是我的作业要求和目前代码，我有一个想修改的地方如下：

1. 可以看到我的实验结果显示是采用滑动中值滤波进行结果平滑，取最近5次测量的中值作为稳定输出。
2. 但我认为这个方案不太符合我的具体需求，有可能导致结果很差。
3. 我希望做一个新的滤波方案其方案既能帮我去掉一些误差过大的情况，又能在我缓慢移动的时候反映真实变化，还能在不移动的时候让我的每一次结果都很稳定不要变来变去
4. 帮我想一个滤波方案，先不必要给代码
