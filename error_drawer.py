...
# 原始数据 (左侧列)
raw_data_list = [
    0.9786, 1.0356, 1.0211, 1.0, 1.0214, 0.9855, 1.0426, 1.0143,
    1.0069, 0.9819, 0.9997, 1.0419, 0.9851, 1.0065, 0.9816
]

# 滤波后数据 (右侧列)
filtered_data_list = [
    0.9786, 1.0071, 1.0211, 1.0106, 1.0211, 1.0211, 1.0211, 1.0143,
    1.0143, 1.0069, 1.0069, 1.0069, 0.9997, 0.9997, 0.9997
]
