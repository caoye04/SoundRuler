...
# 原始数据 (raw_distance_m - 3.1)
raw_data_list = [
    7.0252, 7.0007, 6.9926, 6.1215, 7.0175, 6.9999, 7.0138, 6.1,
    6.7959, 7.0007, 6.789, 7.0327, 7.0043, 7.0185, 7.0067, 7.004,
    7.0284, 7.0647, 7.0102
]

# 滤波后数据 (distance_m)
filtered_data_list = [
    7.0252, 7.013, 7.0007, 6.9967, 7.0007, 6.9999, 6.9999, 6.9999,
    6.9999, 6.9999, 6.7959, 6.7959, 7.0007, 7.0043, 7.0067, 7.0067,
    7.0067, 7.0185, 7.0102
]
