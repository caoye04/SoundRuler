...
<img src="pic4rep/1.jpg" style="zoom:40%;" />
...
<img src="pic4rep/2.jpg" style="zoom:40%;" />
...
<img src="pic4rep/3.jpg" style="zoom:40%;" />

> 图像分析入口例图：点击某一个点之后就能直接点“分析图像”获取该点的分析

<img src="pic4rep/4.jpg" style="zoom:40%;" />
...
16次测试数据的真实测量结果列表、中值滤波后测量结果（显示结果）列表、测量结果折线图、均值分析、方差分析如下

- 真实测量结果列表与中值滤波后测量结果列表

  | 测量点 | 真实测量结果 | 中值滤波后测量结果（显示结果） |
  | ------ | ------------ | ------------------------------ |
  | 1      |              |                                |
  | 2      |              |                                |
  | 3      |              |                                |
...
- 测量结果折线图（前端界面截图）
  ...
  <img src="pic4rep/7.jpg" style="zoom:40%;"/>
